...
def main(top_block_cls=hurdle2_solution_stub_autogenerated, options=None):
    ...
    answer = result_submitter.make_prediction(self.sample_filename)
    success = result_submitter.submit_my_answer(answer, tb.hurdle2_scoring_host, tb.hurdle2_result_port)
